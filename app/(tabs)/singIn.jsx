...
const SignUp = () => {
  ...
  const validateForm = () => {
    ...
    else if (!/^[a-zA-Z0-9._%+-]+@socotec\.com$/.test(email))
  ...
  const renderInput = (
    ...
    <Animated.View style={animatedInputStyle}>
      <TextInput
        ...
        left={
          <TextInput.Icon
            icon={() => <Ionicons name={icon} size={20} color="#00ACE8" />}
          />
        }
        error={!!error}
  ...
  return (
    <>
      ...
      <AlertaIcono
        onOpen={isOpenSucces}
        onClose={() => setIsOpenSucces(false)}
        icon="check"
        title="Exito"
        text="Correo de confirmacion enviado exitosamente"
        actions={
          <>
      ...
      <AlertaScroll
        ...
        actions={
          ...
          >
            <Button textColor="black" onPress={() => setIsOpen(false)}>
              Cerrar
            </Button>
            <Button
              mode="contained"
