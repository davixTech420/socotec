...
const initialTeamMembers = [
  { id: 1, name: 'Alex Chen', avatar: 'https://randomuser.me/api/portraits/men/32.jpg', role: 'UI Designer' },
  { id: 2, name: 'Sarah Johnson', avatar: 'https://randomuser.me/api/portraits/women/44.jpg', role: 'Frontend Developer' },
  { id: 3, name: 'Miguel Rodriguez', avatar: 'https://randomuser.me/api/portraits/men/46.jpg', role: 'Backend Developer' },
  { id: 4, name: 'Aisha Patel', avatar: 'https://randomuser.me/api/portraits/women/65.jpg', role: 'Project Manager' },
];

const initialTasks = [
  { id: 1, title: 'Design new dashboard', description: 'Create wireframes for the new analytics dashboard', status: 'In Progress', assignedTo: 1, priority: 'High', dueDate: '2023-12-15' },
  { id: 2, title: 'Implement authentication', description: 'Add OAuth integration with Google and Apple', status: 'To Do', assignedTo: 3, priority: 'Medium', dueDate: '2023-12-20' },
  { id: 3, title: 'Fix responsive layout', description: 'Address layout issues on mobile devices', status: 'In Progress', assignedTo: 2, priority: 'High', dueDate: '2023-12-10' },
  { id: 4, title: 'Weekly team meeting', description: 'Discuss project progress and blockers', status: 'To Do', assignedTo: 4, priority: 'Low', dueDate: '2023-12-08' },
  { id: 5, title: 'API documentation', description: 'Update the API documentation with new endpoints', status: 'Done', assignedTo: 3, priority: 'Medium', dueDate: '2023-12-05' },
];
          ...
          <Card.Content>
            ...
            <View style={styles.taskFooter}>
              <View style={styles.assigneeContainer}>
                <Avatar.Image size={24} source={{ uri: assignedMember?.avatar }} />
      ...
      >
        ...
        <View style={styles.memberInfo}>
          ...
          <View style={styles.progressContainer}>
            ...
            <Text style={styles.progressText}>{completedTasks}/{memberTasks.length} tasks</Text>
          </View>
        </View>
      </Animated.View>
    </Pressable>
      ...
      >
        {filteredTasks.length > 0 ? (
          ...
          <View style={styles.emptyState}>
            <MaterialCommunityIcons name="clipboard-text-outline" size={64} color={theme.colors.disabled} />
              ...
              <View style={styles.chipContainer}>
                {['Low', 'Medium', 'High'].map(priority => (
                  <Chip
                    ...
                    style={[
                      styles.chip,
                      { backgroundColor: newTask.priority === priority ? priorityColors[priority] : theme.colors.surface }
                    ]}
                    textStyle={{ color: newTask.priority === priority ? 'white' : theme.colors.text }}
                  >
                    {priority}
                  </Chip>
                ))}
              ...
              <View style={styles.chipContainer}>
                {['To Do', 'In Progress', 'Done'].map(status => (
                  <Chip
                    ...
                    style={[
                      styles.chip,
                      { backgroundColor: newTask.status === status ? statusColors[status] : theme.colors.surface }
                    ]}
                    textStyle={{ color: newTask.status === status ? 'white' : theme.colors.text }}
                  >
                    {status}
                  </Chip>
                ))}
